...
{/*「main(void){」で始まり「}」で終わります*/
    int price1,price2,price3,subtotal,tax_price,total;/*「price1」「price2」「price3」「subtotal」「tax_price」「total」という変数を宣言しています。同じ型の変数は，変数名をカンマ（,）で区切ることによって，まとめて宣言することができます。*/
