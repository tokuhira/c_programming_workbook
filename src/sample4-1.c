...
{/*「main(void){」で始まり「}」で終わります*/
    printf("画面に表示するプログラム\n");/*C言語が用意している画面に文字列を表示する命令（関数）です。「"」で囲まれた文字列が画面に表示されます。詳細は後に学習します。最後の「|n");」は半角文字でなけれはなりません*//*「画面に表示するプログラム」という文字列を画面に表示させています 「|n");」はすべて半角文字です 「|n」は後で学習するのでここでは気にしなくて構いません*/
